...
def add_to_dict(_dict, key, value=None):
    if type(_dict) != dict:
        print(f"You need to send a dictionary. You sent: {type(_dict)}")
        return
    if value == None:
        print("You need to send a word nad a definition.")
        return
    if key in _dict:
...
def get_from_dict(_dict, key=None):
    if type(_dict) != dict:
        print(f"You need to send a dictionary. You sent: {type(_dict)}")
        return
    if key == None:
...
def update_word(_dict, key, value=None):
    if type(_dict) != dict:
        print(f"You need to send a dictionary. You sent: {type(_dict)}")
        return
    if value == None:
...
def delete_from_dict(_dict, key=None):
    if type(_dict) != dict:
        print(f"You need to send a dictionary. You sent: {type(_dict)}")
        return
    if key == None:
